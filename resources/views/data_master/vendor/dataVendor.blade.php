                                                            ...
                                                            <form>
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="nama">Nama
                                                                            Vendor</label>
                                                                        <input type="namaVendor" class="form-control"
                                                                            id="alamat"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            id="contactPerson" placeholder="Masukan Nama">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="telp">No.
                                                                            Telp/HP</label>
                                                                        <input type="text" class="form-control"
                                                                            id="telp" placeholder="089501100696">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="npwp">Nomor
                                                                            NPWP</label>
                                                                        <input type="text" class="form-control"
                                                                            id="npwp" placeholder="01-02.03121142">
                                                                    </div>
                                                                    <div class="form-group">

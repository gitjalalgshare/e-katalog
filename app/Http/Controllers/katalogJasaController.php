...
class katalogJasaController extends Controller
{
    /**
    ...
    public function katalogJasa()
    {
        return view('data_katalog.dataKatalogJasa');
    }
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($datas)
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<a href="/showPurchaseJasa/' . $row->hpurchaseId . '"  id="show-purchase" data-id="' . $row->hpurchaseId . '|' . $row->dpurchaseId . '"class="btn btn-sm btn-primary show-purchse mb-0" > <i class="fas fa-edit"></i> Detail</a>';
    ...
    public function showPurchaseJasa($id)
    {
        ...
        return view('data_katalog.detailKatalogJasa', compact('cost', 'branch', 'dtPurchase', 'dtPurchaseDet'));
    }
